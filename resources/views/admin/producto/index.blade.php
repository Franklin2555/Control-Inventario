                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'producto'">{{ trans('admin.producto.columns.producto') }}</th>
                                        <th is='sortable' :column="'tiempo'">{{ trans('admin.producto.columns.tiempo') }}</th>
                                        <th is='sortable' :column="'precio'">{{ trans('admin.producto.columns.precio') }}</th>
                                        <th is='sortable' :column="'categoria_id'">{{ trans('admin.producto.columns.categoria_id') }}</th>
                                        <th is='sortable' :column="'inventario_id'">{{ trans('admin.producto.columns.inventario_id') }}</th>
