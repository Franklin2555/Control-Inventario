                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'costo'">{{ trans('admin.producto.columns.costo') }}</th>
                                        ...
                                        <th is='sortable' :column="'fecha_expiracion'">{{ trans('admin.producto.columns.fecha_expiracion') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.precio }}</td>
                                        <td>@{{ item.cantidad }}</td>
                                        <td>@{{ item.fecha_expiracion | date }}</td>
