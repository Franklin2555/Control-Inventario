        ...
        <p class="login-text">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="uk-inline">
                    ...
                    <input class="uk-input inputSt" id="email" type="email" class="form-control @error('email') is-invalid @enderror" 
                ...
                <div class="uk-inline">
                    ...
                    <input class="uk-input inputSt" id="password" type="password" class="form-control @error('password') is-invalid @enderror" 
