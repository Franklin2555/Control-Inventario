        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="uk-logo uk-navbar-item" href="/home">
                    <img class="logo" src="{{ asset('img/logo.png') }}" data-bs-toggle="tooltip" title="Ir a Inicio">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a style="color: white; text-decoration: none" id="navbarDropdown" class="nav-link dropdown-toggle" href="#" 
                            role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                <i class="fas fa-user-tie fa-lg"></i> Bienvenido:  <b style="color: lightskyblue">{{ Auth::user()->name }}</b>
                            </a>

                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a style="text-align: center; text-decoration: none" class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
